...
macro_rules! endpoint_descriptor {
    ($($key:ident : $value:expr),*) => {
        merge!(
            libusb_sys::libusb_endpoint_descriptor {
                bLength:          7,
...
macro_rules! interface_descriptor {
    ($($key:ident : $value:expr),*) => {
        merge!(
            libusb_sys::libusb_interface_descriptor {
                bLength:            9,
    ...
    ($($endpoint:expr),+) => {
        {
            ...
            let r = libusb_sys::libusb_interface_descriptor {
                bLength:            9,
                bDescriptorType:    0x04,
                bInterfaceNumber:   0,
                bAlternateSetting:  0,
    ...
    ($($descriptor:expr),*) => {
        {
            ...
            let r = libusb_sys::libusb_interface {
...
macro_rules! config_descriptor {
    ($($key:ident : $value:expr),*) => {
        merge!(
            libusb_sys::libusb_config_descriptor {
                bLength:             9,
    ...
    ($($interface:expr),+) => {
        {
            ...
            let r = libusb_sys::libusb_config_descriptor {
                bLength:             9,
                bDescriptorType:     0x02,
                wTotalLength:        9,
...
macro_rules! device_descriptor {
    ($($key:ident : $value:expr),*) => {
        merge!(
            libusb_sys::libusb_device_descriptor {
                bLength:            18,
